 ...
 */
final class Version20241214190021 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "notifications" (demand_uuid UUID NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, action VARCHAR(255) NOT NULL, notification_identifier VARCHAR(255) NOT NULL, channel VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(demand_uuid))');
