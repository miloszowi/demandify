 ...
 */
final class Version20250406180430 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "external_service_configuration" (external_service_name VARCHAR(255) NOT NULL, eligible_approvers TEXT NOT NULL, PRIMARY KEY(external_service_name))');
        $this->addSql('COMMENT ON COLUMN "external_service_configuration".eligible_approvers IS \'(DC2Type:simple_array)\'');
